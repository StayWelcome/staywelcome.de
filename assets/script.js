...
/***/ function(module, exports, __webpack_require__) {
	...
	window.addEventListener('load', function (e) {
	    ...
	    (0, _header.evaluateStickyHeader)();
...
/***/ function(module, exports) {
	...
	var STICKY_STATE_CLASS = 'is-sticky';

	var headerElement = document.querySelector('.header');
	var pseudoHeaderElement = createPseudoHeaderElement();
	...
	function getAbsoluteHeight(el) {
	    ...
	    var spacing = parseFloat(styles['paddingTop']) + parseFloat(styles['paddingBottom']) + parseFloat(styles['marginTop']) + parseFloat(styles['marginBottom']);
